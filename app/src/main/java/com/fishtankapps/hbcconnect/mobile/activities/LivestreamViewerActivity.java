...
import com.fishtankapps.hbcconnect.mobile.pageui.livestream.FacebookLivestreamViewer;
...
public class LivestreamViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String livestreamID = getIntent().getStringExtra(getString(R.string.livestream_id));
        ...
        try {
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle(getIntent().getStringExtra(getString(R.string.livestream_name)));
