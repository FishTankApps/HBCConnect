...
public class SubmitPrayerRequestActivity extends AppCompatActivity {
    ...
    private void submitCountMeIn(){
        ...
        if(submittedCountMeInCard.isInputValid()){
            SendMail sendMail = new SendMail(() -> this, "New Virtual Count Me In Card! #" + (long) (Math.random() * 1_000_000_000), submittedCountMeInCard.getHTMLEmail(), "Prayer Request", getResources().getString(R.string.hbc_admin_email));
            sendMail.execute();
